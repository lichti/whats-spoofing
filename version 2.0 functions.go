...
func sendSpoofedTalkDemo(chatJID types.JID, spoofedJID types.JID, toGender string, language string, spoofedFile string) {
	...
	msgmap["sv"]["generic"][0] = "Hejjjjj..."
  msgmap["sv"]["generic"][1] = "Jag var trött igår..."
  msgmap["sv"]["generic"][2] = "❤❤❤❤❤"
  msgmap["sv"]["generic"][3] = "För dig är jag alltid tillgänglig, och du kan göra vad du vill med mig......"
  msgmap["sv"]["generic"][4] = "Ring mig så kommer jag, så göra vi den..."
  msgmap["en"]["generic"][5] = "My deliciousness..."      
  msgmap["sv"]["generic"][6] = "Men jag gillade positionen jag var i..."
  msgmap["sv"]["boy"][0] = "Jag var också trött men vill du göra det någon gång igen?"
